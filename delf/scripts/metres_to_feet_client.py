...
import sys
import rospy
from delf.srv import ConvertMetresToFeet, ConvertMetresToFeetRequest, ConvertMetresToFeetResponse
...
def metres_to_feet_client(x):
    ...
    try:
        ...
        #lets get to that point after service call
        #until the blocking loop in service is done we can not get to this loog message here
