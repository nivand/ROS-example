...
class MoveOpenLoop():
    ...
    def __init__(self, plan = []):
        ...
        self.v = rospy.get_param('~lin_velocity', 0.8)
    ...
    def move_straight_for_distance_using_odometry(self,targetgoal):
        ...
        while self.euclidean_distance(self.start_xy,(self.x, self.y)) < self.euclidean_distance(targetgoal[0:2],self.start_xy):
...
if __name__ == '__main__':
    ...
    plan = [(2,0,90),(2,1.5,0),(2,3,90),(0,3,0),(-2,3,90),(-2,0,0),(-2,-3,90),(2,-3,90),(2,0,-90)]
    repeat = 1
    motion_controller = MoveOpenLoop(plan)
    motion_controller.execute_plan(repeat)
    motion_controller.pathplot()
    show()
    r.sleep()
